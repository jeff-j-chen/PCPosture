...
from model_strided.block.vanilla_transformer_encoder import Transformer
from model_strided.block.strided_transformer_encoder import Transformer as Transformer_reduce
