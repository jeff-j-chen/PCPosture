...
from libs_strided.yolov3.util import *
from libs_strided.yolov3.darknet import Darknet
from libs_strided.yolov3 import preprocess
...
def arg_parse():
    ...
    parser.add_argument('-wf', '--weight-file', type=str, default= 'demo/libs_strided/checkpoint/yolov3.weights', help='The path'
